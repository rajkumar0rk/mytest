...
export interface ITargetsColumnCallbacks extends IPropertiesTreeCallbacks {
  ...
  onCreateTarget: (id:string,type:string,isSource:boolean) => void;
}
                      ...
                      actions={
                        t.type === DocumentType.CSV
                          ...
                          : [
                              ...
                              position={'top'}
                              enableFlip={true}
                              content={<div>Add a document for use in mapping</div>}
                              key={'create-target-document'}
                              entryDelay={750}
                              exitDelay={100}
                            >
                              <Button
                                onClick={()=>onCreateTarget(t.id,t.type,isSource)}
                                variant={'plain'}
                                aria-label="Add a document for use in mapping"
